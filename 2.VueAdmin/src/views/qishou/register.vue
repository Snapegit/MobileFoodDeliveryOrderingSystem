	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">骑手账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.qishouzhanghao" 
						 placeholder="请输入骑手账号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">骑手密码：</div>
					<el-input class="list_inp"
						 v-model="registerForm.qishoumima" 
						 placeholder="请输入骑手密码"
						 type="password"
						 />
				</div>
				<div class="list_item">
					<div class="list_label">确认骑手密码：</div>
					<el-input class="list_inp" v-model="registerForm.qishoumima2" type="password" placeholder="请输入确认骑手密码" />
				</div>
				<div class="list_item">
					<div class="list_label">骑手姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.qishouxingming" 
						 placeholder="请输入骑手姓名"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.qishouzhanghao)){
			context?.$toolUtil.message(`骑手账号不能为空`,'error')
			return false
		}
		if((!registerForm.value.qishoumima)){
			context?.$toolUtil.message(`骑手密码不能为空`,'error')
			return false
		}
		if((!registerForm.value.qishouxingming)){
	...
	.register_view {
		...
		.list_file_list  {
			...
			:deep(.el-upload--picture-card){
				border: 1px solid #6e945b30;
				cursor: pointer;
				background-color: #6e945b10;
				border-radius: 0px;
				width: 160px;
				line-height: 70px;
				text-align: center;
