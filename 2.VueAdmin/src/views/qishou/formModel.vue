		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="骑手密码" prop="qishoumima">
							<el-input class="list_inp" v-model="form.qishoumima" placeholder="骑手密码"
								type="password" :readonly="!isAdd||disabledForm.qishoumima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='qishoumima'){
					form.value.qishoumima = row[x];
					disabledForm.value.qishoumima = true;
					continue;
				}
				if(x=='qishouxingming'){
