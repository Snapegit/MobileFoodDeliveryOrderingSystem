	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="下单时间" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.addtime}}
					</template>
				</el-table-column>
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('orders'+(orderStatus?'/'+orderStatus:''),'查看评论')" type="warning" @click="commentClick(scope.row.id)">查看评论</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussorders?refid=' + id)
	}
	//初始化
	const init = () => {
		getList()
