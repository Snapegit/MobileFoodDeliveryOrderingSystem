	...
	<div>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">基于前后端分离的外卖点餐系统登录</div>
				...
				<div class="btn_view">
					...
					<el-button class="register" type="primary" @click="handleRegister('qishou')">注册骑手</el-button>
...
<script setup>
	...
	const success = (msg) => {
		isShow.value = false
		context?.$toolUtil.message('验证通过', 'success')
		setTimeout(() => {
			login()
		}, 1500)
	...
	//拼图失败回调
	const fail = () => {
		context?.$toolUtil.message('验证不通过', 'error')
	}
	//注册
