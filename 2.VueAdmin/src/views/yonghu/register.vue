	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">菜色偏好：</div>
					<el-select 
						class="list_sel"
						v-model="registerForm.caisepianhao" 
						placeholder="请选择菜色偏好"
						>
						<el-option v-for="item in yonghucaisepianhaoLists" :label="item" :value="item"></el-option>
					</el-select>
				</div>
...
<script setup>
	...
	const yonghucaisepianhaoLists = ref([])
	const init=()=>{
		yonghuxingbieLists.value = "男,女".split(',')
		yonghucaisepianhaoLists.value = "酸甜,香辣,咸鲜,清淡,麻辣".split(',')
	}
