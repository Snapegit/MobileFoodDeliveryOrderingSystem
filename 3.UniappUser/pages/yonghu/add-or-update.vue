	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="select">
				...
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' @change="caisepianhaoChange" :value="caisepianhaoIndex"  :range="caisepianhaoOptions">
					<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#666666"}' class="uni-input">{{ruleForm.caisepianhao?ruleForm.caisepianhao:"请选择菜色偏好"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			// 自定义下拉框值
			this.caisepianhaoOptions = "酸甜,香辣,咸鲜,清淡,麻辣".split(',')
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='caisepianhao'){
					this.ruleForm.caisepianhao = obj[o];
					this.ro.caisepianhao = true;
					continue;
					}
					if(o=='money'){
		...
		methods: {
			...
			// 下拉变化
			caisepianhaoChange(e) {
				this.caisepianhaoIndex = e.target.value
				this.ruleForm.caisepianhao = this.caisepianhaoOptions[this.caisepianhaoIndex]
			},
