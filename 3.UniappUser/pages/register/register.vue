...
<view class="content">
	<view class="box" :style='{"minHeight":"100vh","width":"100%","padding":"120rpx 44rpx 244rpx 44rpx","background":"url(http://clfile.zggen.cn/20231123/c6d484065a734fe1846d30e79a9f9574.jpg) no-repeat center top / 100% 100%","height":"100%"}'>
		<view :style='{"padding":"0px 48rpx 40rpx 48rpx","boxShadow":"0px 0px 0px #dddddd","margin":"0 0 244rpx 0","borderRadius":"24rpx","background":"none","display":"block","width":"100%","position":"relative","height":"auto"}'>
			...
			<picker :style='{"border":"2rpx solid #00000010","padding":"0 20rpx","margin":"0 0 24rpx 0","borderRadius":"40rpx","background":"#00000040","width":"100%","height":"auto"}' v-if="tableName=='yonghu'"  @change="yonghucaisepianhaoChange" :value="yonghucaisepianhaoIndex" :range="yonghucaisepianhaoOptions">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#999999"}' class="uni-input">{{ruleForm.caisepianhao?ruleForm.caisepianhao:"请选择菜色偏好"}}</view>
			</picker>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='qishou'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.qishouzhanghao" type="text" class="uni-input" name="" placeholder="骑手账号" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='qishou'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.qishoumima" type="password" class="uni-input" name="" placeholder="骑手密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='qishou'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.qishoumima2" type="password" class="uni-input" name="" placeholder="确认骑手密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='qishou'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.qishouxingming" type="text" class="uni-input" name="" placeholder="骑手姓名" />
			</view>
            <view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='qishou'" @tap="qishoutouxiangTap" class="">
                <view>请上传头像</view>
                <image :style='{"width":"160rpx","borderRadius":"0px","objectFit":"contain","display":"block","height":"120rpx"}' v-if="ruleForm.touxiang" class="avator" :src="baseUrl+ruleForm.touxiang" mode=""></image>
                <image :style='{"width":"160rpx","borderRadius":"0px","objectFit":"contain","display":"block","height":"120rpx"}' v-else class="avator" src="../../static/gen/upload.png" mode=""></image>
            </view>
			<picker :style='{"border":"2rpx solid #00000010","padding":"0 20rpx","margin":"0 0 24rpx 0","borderRadius":"40rpx","background":"#00000040","width":"100%","height":"auto"}' v-if="tableName=='qishou'"  @change="qishouxingbieChange" :value="qishouxingbieIndex" :range="qishouxingbieOptions">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#999999"}' class="uni-input">{{ruleForm.xingbie?ruleForm.xingbie:"请选择性别"}}</view>
			</picker>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='qishou'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.shoujihaoma" type="text" class="uni-input" name="" placeholder="手机号码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.shangjiazhanghao" type="text" class="uni-input" name="" placeholder="商家账号" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.shangjiamima" type="password" class="uni-input" name="" placeholder="商家密码" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.shangjiamima2" type="password" class="uni-input" name="" placeholder="确认商家密码" />
			</view>
            <view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" @tap="shangjiatouxiangTap" class="">
                <view>请上传头像</view>
                <image :style='{"width":"160rpx","borderRadius":"0px","objectFit":"contain","display":"block","height":"120rpx"}' v-if="ruleForm.touxiang" class="avator" :src="baseUrl+ruleForm.touxiang" mode=""></image>
                <image :style='{"width":"160rpx","borderRadius":"0px","objectFit":"contain","display":"block","height":"120rpx"}' v-else class="avator" src="../../static/gen/upload.png" mode=""></image>
            </view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.shangjiamingcheng" type="text" class="uni-input" name="" placeholder="商家名称" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.lianxidianhua" type="text" class="uni-input" name="" placeholder="联系电话" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.shangjiadizhi" type="text" class="uni-input" name="" placeholder="商家地址" />
			</view>
			<view :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}' v-if="tableName=='shangjia'" class="uni-form-item uni-column">
				<input :style='{"border":"2rpx solid #00000010","padding":"0px 24rpx 0 24rpx","margin":"0 0 0px 0","color":"#999999","borderRadius":"40rpx","background":"#00000040","width":"100%","fontSize":"28rpx","height":"80rpx"}'  v-model="ruleForm.lianxiren" type="text" class="uni-input" name="" placeholder="联系人" />
			</view>
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='yonghu'){
				...
				this.ruleForm.caisepianhao=this.yonghucaisepianhaoOptions[0]
			}
			// 自定义下拉框值
			if(this.tableName=='qishou'){
                this.qishouxingbieOptions = "男,女".split(',');
				this.ruleForm.xingbie=this.qishouxingbieOptions[0]
			}
		...
		methods: {
			...
			async register() {
                ...
                if(`qishou` == this.tableName && (this.ruleForm.qishoumima!=this.ruleForm.qishoumima2)){
                    this.$utils.msg(`两次密码输入不一致`);
                    return
                }
                ...
                if(`shangjia` == this.tableName && (this.ruleForm.shangjiamima!=this.ruleForm.shangjiamima2)){
                    this.$utils.msg(`两次密码输入不一致`);
                    return
                }
