	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<view class="listBox recommend" :style='{"width":"100%","margin":"40rpx 0 40rpx 0","background":"#ffffff","order":"1"}'>
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","textAlign":"center","background":"#3da742","display":"inline-block","width":"auto","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>菜品信息推荐</view>
			</view>
			...
			<view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap('caipinxinxi',product.id)" v-for="(product,index) in caipinxinxilist" :key="index" class="list-item" :style='{"border":"2rpx solid #3da74250","padding":"20rpx","margin":"0 0 32rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
					<view :style='{"border":"0px solid #cdf6f2","padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"center","overflow":"hidden","borderRadius":"40rpx","background":"#ffffff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">菜品名称:{{product.caipinmingcheng}}</view>
					<image :style='{"padding":"0 0 0 0","margin":"0 0 12rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"220rpx"}' class="list-item-image" mode="aspectFill" v-if="product.tupian.substring(0,4)=='http'" :src="product.tupian"></image>
					<image :style='{"padding":"0 0 0 0","margin":"0 0 12rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"220rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.tupian?baseUrl+product.tupian.split(',')[0]:''"></image>
					<view :style='{"border":"0px solid #cdf6f2","padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"center","overflow":"hidden","borderRadius":"40rpx","background":"#ffffff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">价格:{{product.price}}</view>
		...
		<!-- 新闻资讯 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","background":"#3da742","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>美食资讯</view>
